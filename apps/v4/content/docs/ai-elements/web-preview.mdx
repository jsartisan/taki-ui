...
<ComponentPreview name="web-preview-demo" description="Web preview with navigation and console" />
...
```bash
npx shadcn@latest add web-preview
```
...
<ComponentPreview name="web-preview-demo" description="Full web preview with navigation controls and console" />
