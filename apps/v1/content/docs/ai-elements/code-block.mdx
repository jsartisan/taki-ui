...
<ComponentPreview
  ...
  description="A code block with syntax highlighting and copy button."
/>
...
```bash
npx taki-ui@latest add code-block
```
...
<ComponentPreview
  ...
  description="A code block without a header."
/>
...
<ComponentPreview
  ...
  description="Code block with highlighted lines using [!code highlight] notation."
/>
...
<ComponentPreview
  ...
  description="Code block with highlighted words using [!code word:text] notation."
/>
...
<ComponentPreview
  ...
  description="Code block showing diff with additions and deletions."
/>
...
<ComponentPreview
  ...
  description="Code block with focused lines, blurring other lines."
/>
...
<ComponentPreview
  ...
  description="Code block with custom Shiki themes."
/>
...
<ComponentPreview
  ...
  description="Code block with multiple files using a select dropdown."
/>
