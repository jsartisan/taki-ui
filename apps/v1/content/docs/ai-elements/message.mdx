...
<ComponentPreview
  name="message-demo"
  description="A message component with user and assistant messages."
/>
...
```bash
npx taki-ui@latest add message
```
...
<Message from="user">
  ...
  <MessageContent>Can you explain how quantum computing works?</MessageContent>
</Message>
```
...
<ComponentPreview
  name="message-flat"
  description="A message with flat variant styling."
/>
