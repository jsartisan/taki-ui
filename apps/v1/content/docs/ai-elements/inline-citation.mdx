...
<ComponentPreview
  ...
  description="Inline citations with hover preview"
/>
...
<ComponentSource
  ...
  title="ai-elements/inline-citation.tsx"
/>
...
<InlineCitation>
  ...
  <InlineCitationCard>
    ...
    <InlineCitationCardBody>{/* Citation content */}</InlineCitationCardBody>
  </InlineCitationCard>
</InlineCitation>
```
...
<ComponentPreview
  name="inline-citation-demo"
  description="Citations with carousel preview"
/>
