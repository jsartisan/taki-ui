...
<ComponentPreview
  ...
  description="Chat input with file attachments, speech input, and model selection"
/>
...
```bash
npx taki-ui@latest add prompt-input
```
...
<ComponentPreview
  name="prompt-input-demo"
  description="Full-featured chat input with file attachments, speech input, and model selection"
/>
