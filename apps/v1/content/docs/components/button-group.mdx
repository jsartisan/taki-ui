...
```bash
npx taki-ui@latest add button-group
```
...
<ComponentPreview name="button-group-label" className="mb-4" />

If you just want text instead of a label, use the `ButtonGroupText` component.
