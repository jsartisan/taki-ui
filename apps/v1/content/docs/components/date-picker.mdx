...
<ComponentPreview
  ...
  description="A date picker with label and description."
/>
...
```tsx showLineNumbers
<DatePicker label="Event date" description="Select a date for your event." />
```
...
<ComponentPreview
  name="date-picker-demo"
  description="A basic date picker with label and description."
/>
...
<ComponentPreview
  ...
  description="A date picker with validation."
/>
...
<ComponentPreview
  ...
  description="A controlled date picker."
/>
...
<ComponentPreview
  ...
  description="A date picker with minimum and maximum values."
/>
...
<ComponentPreview
  ...
  description="Date pickers with different granularities."
/>
...
<ComponentPreview
  ...
  description="A date picker with unavailable dates (weekends disabled)."
/>
