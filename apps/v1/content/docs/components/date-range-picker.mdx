...
<ComponentPreview
  ...
  description="A date range picker with label and description."
/>
...
<ComponentPreview
  name="date-range-picker-demo"
  description="A basic date range picker with label and description."
/>
...
<ComponentPreview
  ...
  description="A date range picker with validation."
/>
...
<ComponentPreview
  ...
  description="A controlled date range picker."
/>
...
<ComponentPreview
  ...
  description="A date range picker with minimum and maximum values."
/>
...
<ComponentPreview
  ...
  description="A date range picker with unavailable dates (weekends disabled)."
/>
