...
<ComponentPreview
  ...
  description="A progress bar showing loading progress."
/>
...
<ComponentPreview
  name="progress-bar-demo"
  description="A basic progress bar showing determinate progress."
/>
...
<ComponentPreview
  ...
  description="A progress bar with a custom value label."
/>
...
<ComponentPreview
  ...
  description="Progress bars with custom min and max values."
/>
