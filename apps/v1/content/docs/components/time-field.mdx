...
<ComponentPreview
  ...
  description="A time field with label."
/>
...
```tsx showLineNumbers
<TimeField label="Event time" description="Select a time for your event." />
```
...
<ComponentPreview
  name="time-field-demo"
  description="A basic time field with label."
/>
...
<ComponentPreview
  ...
  description="A time field with a description."
/>
...
<ComponentPreview
  ...
  description="A disabled time field."
/>
...
<ComponentPreview
  ...
  description="Time fields with different granularities."
/>
...
<ComponentPreview
  ...
  description="Time fields with different hour cycles."
/>
...
<ComponentPreview
  ...
  description="A time field with validation."
/>
...
<ComponentPreview
  ...
  description="A controlled time field."
/>
...
export default function AppointmentTime() {
  ...
  return (
    <TimeField label="Appointment time" value={time} onChange={handleChange} />
  )
}
```
