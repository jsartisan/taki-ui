...
<ComponentPreview
  name="tree-demo"
  description="A basic tree with nested items."
/>
...
<ComponentPreview
  name="tree-selection"
  description="Tree with multiple selection support."
/>
...
<ComponentPreview
  ...
  description="Tree with single selection."
/>
...
<ComponentPreview
  name="tree-disabled"
  description="Tree with disabled items."
/>
...
<ComponentPreview
  name="tree-links"
  description="Tree items as navigation links."
/>

```tsx showLineNumbers
import { Tree, TreeItem } from "@/components/ui/tree"

;<Tree aria-label="Navigation" defaultExpandedKeys={["components", "hooks"]}>
...
<ComponentPreview
  name="tree-dynamic"
  description="Tree with dynamically added items."
/>
...
```tsx
<Tree aria-label="File system">{/* items */}</Tree>
```
