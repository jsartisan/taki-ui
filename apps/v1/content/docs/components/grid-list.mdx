...
<ComponentPreview
  ...
  description="A list with multiple selection support."
/>
...
<ComponentPreview
  ...
  description="A list with action buttons."
/>
...
<ComponentPreview
  ...
  description="A list with disabled items."
/>
...
<ComponentPreview
  ...
  description="A list showing an empty state."
/>
...
```tsx
<GridList aria-label="Favorite pokemon">{/* items */}</GridList>
```
