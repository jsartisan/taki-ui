...
<ComponentPreview
  ...
  description="A disclosure group component."
/>
...
<DisclosureGroup>
  <Disclosure id="personal">
    ...
    <DisclosurePanel>Enter your personal details.</DisclosurePanel>
  </Disclosure>
  <Disclosure id="billing">
    <DisclosureHeader>Billing Address</DisclosureHeader>
    <DisclosurePanel>Provide your billing address.</DisclosurePanel>
  </Disclosure>
</DisclosureGroup>
```
...
<ComponentPreview
  name="disclosure-group-demo"
  description="A disclosure group with multiple items."
/>
...
<ComponentPreview
  ...
  description="A disclosure group with a default expanded item."
/>
...
<DisclosureGroup defaultExpandedKeys={["system"]}>
  ...
  <Disclosure id="installation">
    ...
    <DisclosurePanel>Run npm install to install dependencies.</DisclosurePanel>
  </Disclosure>
</DisclosureGroup>
```
...
<ComponentPreview
  ...
  description="A disclosure group allowing multiple expanded items."
/>
...
<ComponentPreview
  ...
  description="A controlled disclosure group."
/>
...
<ComponentPreview
  ...
  description="A disclosure group with disabled items."
/>
